...
install -Dm644 "${DESKTOP_SRC}" "${STAGE_DIR}/usr/share/APPLaunch/applications/groveenv.desktop"
...
Description: Grove ENV monitor for M5CardputerZero APPLaunch
 Grove ENV monitor app for SHT30 temperature and humidity sensors.
EOF
