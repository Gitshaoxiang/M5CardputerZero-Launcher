...
install -Dm644 "${DESKTOP_SRC}" "${STAGE_DIR}/usr/share/APPLaunch/applications/irremote.desktop"
...
Description: Infrared appliance controller for M5CardputerZero APPLaunch
 Multi-page remote for air conditioners, fans and scene macros.
EOF
