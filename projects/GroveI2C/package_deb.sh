...
install -Dm644 "${DESKTOP_SRC}" "${STAGE_DIR}/usr/share/APPLaunch/applications/grovei2c.desktop"
...
Description: Grove I2C scanner for M5CardputerZero APPLaunch
 Grove I2C scanner app and APPLaunch desktop entry.
EOF
